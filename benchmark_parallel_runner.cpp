...
int main() {
    ...
    auto runner = make_parallel_runner(
        ...
        parallel_step([]() { return true; }, "Step 2 failed"),
        parallel_step([]() { return true; }, "Step 3 failed"),
        parallel_step([]() { return true; }, "Step 4 failed"),
        parallel_step([]() { return true; }, "Step 5 failed")
    );
    
    // Lambdas with captures
    int counter = 0;
    auto runner_with_captures = make_parallel_runner(
        parallel_step([&counter]() { counter++; return true; }, "Step 1 failed"),
        parallel_step([&counter]() { counter++; return true; }, "Step 2 failed"),
        parallel_step([&counter]() { counter++; return true; }, "Step 3 failed"),
        parallel_step([&counter]() { counter++; return true; }, "Step 4 failed"),
        parallel_step([&counter]() { counter++; return true; }, "Step 5 failed")
    );
